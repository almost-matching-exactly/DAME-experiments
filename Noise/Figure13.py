...
#flame
with open("res/DAME-x11",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)


with open("res/DAME-y11",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)

mse.append(MSE(FLAME_early_x, FLAME_early_y))

with open("res/DAME-x12",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)


with open("res/DAME-y12",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

#flame early
with open("res/DAME-x13",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)

with open("res/DAME-y13",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

with open("res/DAME-x",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)

with open("res/DAME-y",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

with open("res/DAME-x21",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)


with open("res/DAME-y21",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

with open("res/DAME-x22",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)


with open("res/DAME-y22",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

#flame early
with open("res/DAME-x23",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)

with open("res/DAME-y23",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

with open("res/DAME-x31",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)


with open("res/DAME-y31",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

with open("res/DAME-x32",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)


with open("res/DAME-y32",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))

#flame early
with open("res/DAME-x33",'rb') as f:
        FLAME_early_x = pickle.load(f) 
        fexs.append(FLAME_early_x)

with open("res/DAME-y33",'rb') as f:
        FLAME_early_y = pickle.load(f) 
        feys.append(FLAME_early_y)
mse.append(MSE(FLAME_early_x, FLAME_early_y))
